...
ALTER TABLE "invoices" ADD COLUMN "payment_screenshot" varchar(1000);--> statement-breakpoint
ALTER TABLE "properties" ADD COLUMN "khqr_image_url" varchar(1000);--> statement-breakpoint
