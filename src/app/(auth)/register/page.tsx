        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              onChange={handleChange}
              disabled={isLoading || isGoogleLoading}
              className="w-full px-3 py-2 border border-input bg-background/50 rounded-md text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-shadow"
            >
